...
require __DIR__ . '/MainProject/frontend/config/bootstrap.php';

$config = yii\helpers\ArrayHelper::merge(
    require __DIR__ . '/MainProject/common/config/main.php',
    require __DIR__ . '/MainProject/common/config/main-local.php',
    require __DIR__ . '/MainProject/frontend/config/main.php',
    require __DIR__ . '/MainProject/frontend/config/main-local.php'
);
